...
<main className=" scroll-smooth min-h-screen grid  h-fit w-full px-10 py-16 md:py-8 md:px-6 lg:px-12 lg:py-12  bg-gradient-to-b from-black via-gray-500 to-black ">
    ...
    <div className='mt-[100px] hidden md:flex before:rounded-lg before:block before:absolute before:-inset-1 before:-skew-y-3 h-[75vh] top-[10vh] rounded-lg w-[80vw] left-[7vw]  before:bg-[#ffd33c]  relative inline-block'>
