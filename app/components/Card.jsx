  ...
  return (
    <div className='col-span-1 row-span-2 w-full h-full flex flex-col p-2 rounded-lg bg-zinc-800'>
        ...
        <div className='w-full h-1/2 flex flex-col gap-2 text-white p-2 items-center justify-center'>
            ...
            <Link href={`/productos/${prop?.data.URL}`} className='hover:text-[#291504] text-xs p-2 w-fit h-fit rounded-lg text-[#ffd33c] bg-transparent hover:bg-[#ffd33c] hover:text-[#291504] hover:shadow-lg font-bold'>Saber mas</Link>
        </div>
